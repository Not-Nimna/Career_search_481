...
// --- Mock data for Prairie Health System ---
const MOCK_APP: Application = {
  id: "APP-2025-002",
  status: "Submitted",
  submittedISO: "2025-11-01T14:32:00-06:00",
  updatedISO: "2025-11-01T14:32:00-06:00",
  job: {
    id: "prairie-health-system-data-analyst-coop",
  ...
  documents: {
    ...
    cover: { name: "Cover_Letter_Prairie_Health.pdf", sizeMB: 0.25 },
    extras: [
      { name: "wait_time_dashboard_screenshots.pdf", sizeMB: 2.4 },
      { name: "etl_pipeline_diagram.png", sizeMB: 1.1 },
    ],
  },
  answers: {
    why: "I’m excited to use data to improve patient experience across clinics. Prairie Health’s focus on operational insights and wait-time reduction aligns with my interest in analytics that directly impacts people’s care. I’ve built dashboards, automated ETL jobs, and I’d love to bring that experience to your teams.",
    project:
      "Built a Tableau dashboard on emergency department wait-times: joined visit, triage, and staffing tables using SQL; created calculated fields (door-to-doctor, LWBS rate); and added filters by clinic, shift, and acuity. Automated the ETL using Python + cron to pull from a PostgreSQL replica, clean the data, and load into a reporting schema. Presented weekly findings to stakeholders and iterated on the visuals based on their feedback.",
  },
  timeline: [
    {
      when: "2025-11-01T14:32:00-06:00",
...
// --- Component ---
export default function PrairieHealthApplicationDetail() {
  const app = useMemo(() => MOCK_APP, []);
  const [note, setNote] = useState("");

  return (
    <div className="min-h-screen bg-[#F8F7F4]">
      {/* Top bar (same as Aurora page) */}
      ...
      <main className="mx-auto grid max-w-6xl gap-6 px-4 py-6 lg:grid-cols-12">
        ...
        <section className="space-y-6 lg:col-span-8">
            ...
            <CardHeader className="pb-2">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-3 text-sm text-muted-foreground">Analyze patient wait-time data and build dashboards for operational insights across clinics.</p>
          ...
          <Card className="rounded-2xl">
            ...
            <CardContent className="grid gap-4 text-sm text-muted-foreground">
              <div>
                <div className="mb-1 text-xs font-medium text-foreground">Why Prairie Health System?</div>
                <p className="whitespace-pre-wrap">{app.answers.why}</p>
              </div>
              <div>
                <div className="mb-1 text-xs font-medium text-foreground">Analytics / data project</div>
          ...
          <Card className="rounded-2xl">
            ...
            <CardContent>
              <div className="mb-2 text-sm text-muted-foreground">Private notes only you can see (e.g., dashboard ideas, metrics to mention in an interview).</div>
              <div className="flex items-center gap-2">
        ...
        <aside className="space-y-4 lg:col-span-4">
          ...
          <Card className="rounded-2xl">
            ...
            <CardContent className="space-y-2 text-sm text-muted-foreground">
              <div>We’ll email you if you move to a data interview or case study. Typical timeline: 1–2 weeks after the posting deadline.</div>
              <div className="text-xs">Tip: Review SQL joins/window functions, practice explaining a dashboard you built, and prepare 2–3 examples where your analysis changed a decision.</div>
            </CardContent>
          ...
          <Card className="rounded-2xl">
            ...
            <CardContent className="space-y-2 text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                <User2 className="h-4 w-4" /> Analytics Recruiting Team
              </div>
              <div className="flex items-center gap-2">
                <Mail className="h-4 w-4" /> analytics-careers@prairiehealth.example
              </div>
              <div className="flex items-center gap-2">
      ...
      <footer className="border-t bg-white">
        <div className="mx-auto max-w-6xl px-4 py-8 text-sm text-muted-foreground">This view mirrors what you submitted for the Data Analyst Co-op role at Prairie Health System. Keep an eye on your email for updates.</div>
      </footer>
    </div>
  );
}

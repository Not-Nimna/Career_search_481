      ...
      <main className="mx-auto max-w-6xl px-4 py-6 grid gap-6 lg:grid-cols-12">
        ...
        <section className="lg:col-span-8 space-y-6">
          ...
          <Card className="rounded-2xl">
            <CardHeader className="pb-2">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                {job.tags.map((t)=> <Badge key={t} variant="outline" className="rounded-full">{t}</Badge>)}
              </div>
            </CardHeader>
          ...
          <Card className="rounded-2xl">
            ...
            <CardContent className="grid gap-6 md:grid-cols-2 text-sm text-muted-foreground">
              <ul className="list-disc pl-5 space-y-2">
                <li>Implement services and pipelines in <strong>Python</strong> and <strong>C++</strong> for robotics workloads.</li>
            ...
            <CardContent className="grid gap-6 md:grid-cols-2 text-sm text-muted-foreground">
              <div>
                ...
                <ul className="list-disc pl-5 space-y-2">
                  ...
                  <li>Proficiency in <strong>Python</strong> and one of <strong>C++/Go</strong>.</li>
                  <li>Version control with <strong>Git</strong>; comfort with Linux tooling.</li>
                  <li>Familiarity with <strong>ROS/ROS2</strong> and basic robotics concepts.</li>
                </ul>
              </div>
              <div>
                <h3 className="font-medium text-foreground mb-2">Nice to have</h3>
                <ul className="list-disc pl-5 space-y-2">
                  <li>Coursework/projects in <strong>controls</strong>, <strong>computer vision</strong>, or <strong>SLAM</strong>.</li>
                  <li>Experience with <strong>Docker</strong>, <strong>CI/CD</strong>, or cloud compute.</li>
          ...
          <Card className="rounded-2xl">
            ...
            <CardContent className="text-sm text-muted-foreground">
              <ol className="list-decimal pl-5 space-y-2">
                <li><strong>Resume screen</strong> by the hiring team.</li>
                <li><strong>Technical screen</strong> (45 min): Python/C++ coding + basic robotics.</li>
                <li><strong>Panel</strong> (75 min): system design, ROS, and troubleshooting.</li>
                <li><strong>Offer</strong> & timeline discussion.</li>
              </ol>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-2xl">
            ...
            <CardContent className="text-sm text-muted-foreground">
              Aurora Robotics Lab is an equal opportunity employer. We welcome applicants from all backgrounds and provide reasonable accommodations throughout the hiring process.
            </CardContent>
          </Card>
        </section>
        ...
        <aside className="lg:col-span-4 space-y-4">
          <Card className="rounded-2xl">
            ...
            <CardContent className="text-sm text-muted-foreground space-y-2">
              <div className="flex items-center justify-between"><span>Posted</span><span>{job.posted}</span></div>
              <div className="flex items-center justify-between"><span>Deadline</span><span>{fmtDate(job.deadlineISO)}</span></div>
              <div className="flex items-center justify-between"><span>Duration</span><span>{job.duration}</span></div>
              <div className="flex items-center justify-between"><span>Workplace</span><span>{job.workplace}</span></div>
              <div className="flex items-center justify-between"><span>Teams</span><span>{job.teams.join(", ")}</span></div>
            </CardContent>
          ...
          <Card className="rounded-2xl">
            ...
            <CardContent className="grid grid-cols-2 gap-2 text-sm">
              <Badge variant="outline" className="justify-start gap-1"><Code className="h-4 w-4"/> Python</Badge>
              <Badge variant="outline" className="justify-start gap-1"><Code className="h-4 w-4"/> C++</Badge>
              <Badge variant="outline" className="justify-start gap-1"><Bot className="h-4 w-4"/> ROS / ROS2</Badge>
              <Badge variant="outline" className="justify-start gap-1"><Cpu className="h-4 w-4"/> CV/Perception</Badge>
              <Badge variant="outline" className="justify-start gap-1"><CircuitBoard className="h-4 w-4"/> CI/CD</Badge>
              <Badge variant="outline" className="justify-start gap-1"><Network className="h-4 w-4"/> Docker/Linux</Badge>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-2xl">
            ...
            <CardContent className="text-sm text-muted-foreground space-y-2">
              ...
              <a className="inline-flex items-center gap-1 text-primary underline" href="#">Website <ExternalLink className="h-4 w-4"/></a>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-2xl">
            ...
            <CardContent className="text-sm text-muted-foreground space-y-2">
              <div className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-600"/> Production‑oriented robotics work</div>
              <div className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-600"/> Mentorship + weekly demos</div>
              <div className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-emerald-600"/> Hybrid lab access</div>
            </CardContent>
          </Card>
        </aside>
      </main>
